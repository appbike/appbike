...
- (MKAnnotationView *) mapView:(MKMapView *)mapView 
    ...
    if([[annotation title] isEqualToString:@"User"]){
        annView.image = [UIImage imageNamed:@"loc_user.png"];
        annView.centerOffset = CGPointMake(0,-annView.frame.size.height*0.5);
    }

    else if([[annotation title] isEqualToString:@"Bike"]){
        annView.image = [UIImage imageNamed:@"loc_bike.png"];
        annView.centerOffset = CGPointMake(0,-annView.frame.size.height*0.5);
    }
